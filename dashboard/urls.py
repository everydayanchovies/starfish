...
urlpatterns = [re_path(r'^$',
               ...
               re_path(r'^information/(?P<pk>\d+)/$',
                       views.InformationForm.as_view(), name='information_edit'),
               re_path(r'^event/(?P<pk>\d+)/$',
                       views.EventForm.as_view(), name='event_edit'),
               re_path(r'^project/(?P<pk>\d+)/$',
                       views.ProjectForm.as_view(), name='project_edit'),
               ...
               re_path(r'^contribute/information/$',
                       views.InformationForm.as_view(), name='information_contribute'),
               re_path(r'^contribute/event/$',
                       views.EventForm.as_view(), name='event_contribute'),
               re_path(r'^contribute/project/$',
                       views.ProjectForm.as_view(), name='project_contribute'),
               re_path(r'^contribute/goodpractice/$',
                       views.GoodPracticeForm.as_view(), name='goodpractice_contribute'),
               re_path(r'^contribute/glossary/$',
                       views.GlossaryForm.as_view(), name='glossary_contribute'),
               re_path(r'^contribute/question/$',
                       views.QuestionForm.as_view(), name='question_contribute'),
               re_path(r'^contribute/usercase/$',
                       views.UserCaseForm.as_view(), name='user_case_contribute')
               ]
